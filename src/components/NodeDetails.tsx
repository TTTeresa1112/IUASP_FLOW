...
const pmConfig: Record<string, NodeConfig> = {
  ...
  'node-1-1': {
    ...
    miniFlow: {
      nodes: [
        ...
        { id: 'n4', position: { x: 400, y: 132 }, type: 'miniNode', data: { actorLabel: '状态', actor: 'ME 初审', actionLabel: 'ME 初审', currentStatus: '', borderColor: 'green', showAction: false } },
      ],
      edges: [
  ...
  'node-1-2': {
    ...
    miniFlow: {
      nodes: [
        ...
        { id: 'n3', position: { x: 550, y: 138 }, type: 'miniNode', data: { actorLabel: '执行人', actor: 'ME', actionLabel: '初审 ME', currentStatus: '[初审 ME] 等待 ME 初审新稿件' } },
        { id: 'n4', position: { x: 950, y: 170 }, type: 'miniNode', data: { actorLabel: '状态', actor: '初审 EIC', actionLabel: '初审 EIC', currentStatus: '', borderColor: 'orange', showAction: false } },
      ],
      edges: [
        { id: 'e1', source: 'n1', target: 'n2'},
        { id: 'e2', source: 'n2', target: 'n3', label: '通知' },
        { id: 'e3', source: 'n3', target: 'n4', label: '初审拒稿 / EIC 初审' },
      ]
    }
  },
  'node-1-3': {
    ...
    miniFlow: {
      nodes: [      
        ...
        { id: 'n3-1', position: { x: 600, y: -250 }, type: 'miniNode', data: { actorLabel: '执行人', actor: 'ME', actionLabel: 'EIC 初审', currentStatus: '[初审 ME] 等待 ME 确认 EIC 初审', showTopHandle: true } },
        { id: 'n3-2', position: { x: 600, y: 10 }, type: 'miniNode', data: { actorLabel: '执行人', actor: 'ME', actionLabel: 'EIC 初审', currentStatus: '[初审 ME] 等待 ME 确认 EIC 初审', showTopHandle: true } },
        { id: 'n3-3', position: { x: 600, y: 270 }, type: 'miniNode', data: { actorLabel: '执行人', actor: 'ME', actionLabel: 'EIC 初审', currentStatus: '[初审 ME] 等待 ME 确认 EIC 初审', showBottomHandle: true } },
        { id: 'n3-4', position: { x: 600, y: 500 }, type: 'miniNode', data: { actorLabel: '执行人', actor: 'ME', actionLabel: 'EIC 初审', currentStatus: '[编辑部ME审核] 等待 ME 确认 EIC 初审', showBottomHandle: true } },
        ...
        { id: 'n6', position: { x: 950, y: 300 }, type: 'miniNode', data: { actorLabel: '状态', actor: '初审 EIC', actionLabel: '初审 EIC', currentStatus: '', borderColor: 'orange', showAction: false, showTopHandle: true, showBottomHandle: true } },
        ...
        { id: 'n8', position: { x: 1290, y: 268 }, type: 'miniNode', data: { actorLabel: '发起人', actor: 'EIC', actionLabel: 'EIC 分配 AE', currentStatus: '[初审 EIC] 等待 EIC 分配 AE', isCurrent: true } },
        { id: 'n9', position: { x: 1290, y: 497 }, type: 'miniNode', data: { actorLabel: '发起人', actor: 'ME', actionLabel: 'AU 稿件返修', currentStatus: '[提交返修稿见 AU] 等待 AU 稿件返修', isCurrent: true } },
        { id: 'n11', position: { x: 1630, y: 268 }, type: 'miniNode', data: { actorLabel: '执行人', actor: 'ME', actionLabel: 'EIC 分配 AE', currentStatus: '[初审 EIC] 等待 ME 确认 EIC 分配 AE', showTopHandle: true } },
        { id: 'n12', position: { x: 1630, y: 490 }, type: 'miniNode', data: { actorLabel: '执行人', actor: '作者', actionLabel: 'AU 稿件返修', currentStatus: '[提交返修稿见 AU] 等待 AU 提交稿件返修', showBottomHandle: true } },
        { id: 'n13', position: { x: 2000, y: 298 }, type: 'miniNode', data: { actorLabel: '状态', actor: '学术编辑初审', actionLabel: '学术编辑初审', currentStatus: '', borderColor: 'purple', showAction: false } },
        { id: 'n14', position: { x: 2000, y: 530 }, type: 'miniNode', data: { actorLabel: '状态', actor: '初审 ME', actionLabel: '初审 ME', currentStatus: '', borderColor: 'green', showAction: false } }, 
      ],
      edges: [
  ...
  'node-1-4': {
    ...
    miniFlow: {
      nodes: [
        { id: 'n1', position: { x: 50, y: 170 }, type: 'miniNode', data: { actorLabel: '状态', actor: '学术编辑初审', actionLabel: '学术编辑初审', currentStatus: '', borderColor: 'purple', showAction: false } }, 
        { id: 'n2', position: { x: 360, y: 138 }, type: 'miniNode', data: { actorLabel: '发起人', actor: 'AE', actionLabel: 'AE 初审决定', currentStatus: '[AE 初审] 新稿件 AE 初审', isCurrent: true } },
        { id: 'n3', position: { x: 650, y: 170 }, type: 'miniNode', data: { actorLabel: '状态', actor: 'ME审查', actionLabel: 'ME审查', currentStatus: '', borderColor: 'green', showAction: false } },
        { id: 'n4', position: { x: 1000, y: 130 }, type: 'miniNode', data: { actorLabel: '执行人', actor: 'ME', actionLabel: '确认 / 退回AE重新做决定', currentStatus: '[编辑部ME审核] 确认AE初审意见中' } },
        { id: 'n5', position: { x: 1000, y: 380 }, type: 'miniNode', data: { actorLabel: '执行人', actor: 'ME', actionLabel: '确认 / 退回AE重新做决定', currentStatus: '[编辑部ME审核] 确认AE初审意见中' } },
        { id: 'n6', position: { x: 1000, y: -100 }, type: 'miniNode', data: { actorLabel: '执行人', actor: 'ME', actionLabel: '确认 / 退回AE重新做决定', currentStatus: '[编辑部ME审核] 确认AE初审意见中' } },
        { id: 'n7', position: { x: 1280, y: -60 }, type: 'miniNode', data: { actorLabel: '状态', actor: '主编审查', actionLabel: '主编初审', currentStatus: '', borderColor: 'orange', showAction: false } },
        { id: 'n8', position: { x: 1600, y: -130 }, type: 'miniNode', data: { actorLabel: '状态', actor: '系统归档', actionLabel: '系统归档', currentStatus: '', borderColor: 'red', showAction: false } }, 
        { id: 'n9', position: { x: 1600, y: 10 }, type: 'miniNode', data: { actorLabel: '状态', actor: '提交稿件', actionLabel: '提交稿件', currentStatus: '', borderColor: 'white', showBottomHandle: true, showAction: false } },
        { id: 'n10', position: { x: 1600, y: -60 }, type: 'miniNode', data: { actorLabel: '状态', actor: '学术编辑初审', actionLabel: '学术编辑初审', currentStatus: '', borderColor: 'purple', showAction: false } },
        { id: 'n11', position: { x: 1280, y: 170 }, type: 'miniNode', data: { actorLabel: '状态', actor: '选择审稿人', actionLabel: '选择审稿人', currentStatus: '', borderColor: 'purple', showAction: false } },

      ],
      edges: [
        { id: 'e1', source: 'n1', target: 'n2'},
        { id: 'e2', source: 'n2', target: 'n3'},
        { id: 'e3', source: 'n3', target: 'n4', label: '进入同行评议' },
        { id: 'e4', source: 'n3', target: 'n5', label: '需要初审返修' },
        { id: 'e5', source: 'n3', target: 'n6', label: '初审拒稿' },
  ...
  'node-1-5': {
    role: '管理编辑 (ME)',
    workflow: '在学术编辑准备正式送外审之前，ME 从全局视角再次确认整个初审状态是否合规。确认无误后，稿件将正式移交出初审小闭环，跨段进入「同行评议」环节。',
    action: {
      initiator: '学术编辑 (AE)',
      executor: '管理编辑 (ME)',
      ...
      decisions: [
        ...
        { label: '打回异常状态', type: 'revise', nextStep: '退回学术编辑', cc: '主编 (预警)' }
      ]
    },
    diagram: [
      { label: 'AE 建议送审' },
    ...
    states: [
      { role: 'ME端', state: '待处理 - 等待送外审状态确认' },
      { role: '学术编辑端', state: '等待 ME 最终审定方可送外审' },
      { role: '作者端', state: '编委评估中' },
    ],
    miniFlow: {
      nodes: [
        { id: 'n1', position: { x: 50, y: 100 }, type: 'miniNode', data: { actorLabel: '执行人', actor: 'ME', actionLabel: '合规性确认', currentStatus: '等待送外审状态确认', isCurrent: true } },
        { id: 'n2', position: { x: 500, y: 20 }, type: 'miniNode', data: { actorLabel: '执行人', actor: '审稿人', actionLabel: '同行评议', currentStatus: '收到邀请待回复' } },
        { id: 'n3', position: { x: 500, y: 180 }, type: 'miniNode', data: { actorLabel: '执行人', actor: 'AE', actionLabel: '重新评估', currentStatus: '打回异常状态' } },
      ],
      edges: [
        { id: 'e1', source: 'n1', target: 'n2', label: '进入同行评议' },
        { id: 'e2', source: 'n1', target: 'n3', label: '退回异常状态' }
      ]
    }
  },
  'node-2-3': {
