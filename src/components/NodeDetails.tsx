...
const pmConfig: Record<string, NodeConfig> = {
  ...
  'node-1-3': {
    ...
    miniFlow: {
      nodes: [      
        ...
        { id: 'n12', position: { x: 2000, y: 268 }, type: 'miniNode', data: { actorLabel: '发起人', actor: 'ME', actionLabel: '初审 分配 AE', currentStatus: '[初审 EIC] 等待 ME 确认 EIC 分配 AE', isCurrent: true, showTopHandle: true  } },
        { id: 'n13', position: { x: 2350, y: 268 }, type: 'miniNode', data: { actorLabel: '执行人', actor: '系统', actionLabel: '分配 AE 和材料', currentStatus: '[初审 EIC] 等待 系统 分配 AE 和材料', showBottomHandle: true  } },
        { id: 'n14', position: { x: 1630, y: 490 }, type: 'miniNode', data: { actorLabel: '执行人', actor: '作者', actionLabel: 'AU 稿件返修', currentStatus: '[提交返修稿见 AU] 等待 AU 提交稿件返修', showBottomHandle: true } },
        { id: 'n15', position: { x: 2750, y: 298 }, type: 'miniNode', data: { actorLabel: '状态', actor: '学术编辑初审', actionLabel: '学术编辑初审', currentStatus: '', borderColor: 'purple', showAction: false } },
        { id: 'n16', position: { x: 2000, y: 530 }, type: 'miniNode', data: { actorLabel: '状态', actor: '初审 ME', actionLabel: '初审 ME', currentStatus: '', borderColor: 'green', showAction: false } }, 
      ],
      edges: [
  ...
  'node-1-4': {
    ...
    miniFlow: {
      nodes: [      
        { id: 'n1', position: { x: -80, y: 172 }, type: 'miniNode', data: { actorLabel: '状态', actor: '学术编辑初审', actionLabel: '学术编辑初审', currentStatus: '', borderColor: 'purple', showAction: false } },
        { id: 'n2', position: { x: 210, y: 140 }, type: 'miniNode', data: { actorLabel: '发起人', actor: 'AE', actionLabel: '初审 EIC', currentStatus: '[初审 EIC] 等待 EIC 初审新稿件', isCurrent: true } },
        { id: 'n3-1', position: { x: 600, y: -250 }, type: 'miniNode', data: { actorLabel: '执行人', actor: 'ME', actionLabel: 'EIC 初审', currentStatus: '[初审 ME] 等待 ME 确认 EIC 初审', showTopHandle: true } },
        { id: 'n3-2', position: { x: 600, y: 10 }, type: 'miniNode', data: { actorLabel: '执行人', actor: 'ME', actionLabel: 'EIC 初审', currentStatus: '[初审 ME] 等待 ME 确认 EIC 初审', showTopHandle: true } },
        { id: 'n3-3', position: { x: 600, y: 270 }, type: 'miniNode', data: { actorLabel: '执行人', actor: 'ME', actionLabel: 'EIC 初审', currentStatus: '[初审 ME] 等待 ME 确认 EIC 初审', showBottomHandle: true } },
        { id: 'n3-4', position: { x: 600, y: 500 }, type: 'miniNode', data: { actorLabel: '执行人', actor: 'ME', actionLabel: 'EIC 初审', currentStatus: '[编辑部ME审核] 等待 ME 确认 EIC 初审', showBottomHandle: true } },
